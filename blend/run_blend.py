...
parser.add_argument('--blender_path', type=str, default='blender', help='')
parser.add_argument('--script_path', type=str, default=project_root + '/blend/render.py', help='')
parser.add_argument('--blend_path', type=str, default=project_root + '/blend/stage2.blend', help='')
parser.add_argument('--input_folder', type=str, default=project_root + '/blend/local_output333.obj', help='')
...
def render(input_obj_dir, output_folder):
    ...
    print(f'input_obj_dir={input_obj_dir}')
...
if __name__ == "__main__":
    args.gif_frames = 40
    render(input_obj_dir=args.input_folder, output_folder=args.output_folder)
